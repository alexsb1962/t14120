// megafunction wizard: %FIR Compiler v11.0%
// GENERATION: XML
...
// 			fir32tap_old_ast
// ============================================================
// Generated by FIR Compiler 11.0 [Altera, IP Toolbench 1.3.0 Build 208]
// ************************************************************
...
module fir32tap_old (
	...
	fir32tap_old_ast	fir32tap_old_ast_inst(
		.clk(clk),
		.reset_n(reset_n),
...
// Retrieval info: <MEGACORE title="FIR Compiler"  version="11.0"  build="208"  iptb_version="1.3.0 Build 208"  format_version="120" >
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.FIRModelClass"  active_core="fir32tap_old_ast" >
...
// Retrieval info:      <PRIVATE name = "coefficient_scaling_factor" value="33512.63428642777"  type="STRING"  enable="0" />
...
// Retrieval info:      <PRIVATE name = "set_1" value="Low Pass Set, Imported, D:\test\asvm\fir37tap.fcf, -5.79834E-4, -0.002319336, -0.0056152344, -0.009857178, -0.012908936, -0.01184082, -0.0047302246, 0.007232666, 0.018615723, 0.021636963, 0.010650635, -0.012908936, -0.038085938, -0.04748535, -0.025482178, 0.03250122, 0.114471436, 0.19476318, 0.24441528, 0.24441528, 0.19476318, 0.114471436, 0.03250122, -0.025482178, -0.04748535, -0.038085938, -0.012908936, 0.010650635, 0.021636963, 0.018615723, 0.007232666, -0.0047302246, -0.01184082, -0.012908936, -0.009857178, -0.0056152344, -0.002319336, -5.79834E-4"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "number_of_sets" value="1"  type="INTEGER"  enable="1" />
// Retrieval info:      <PRIVATE name = "output_full_bit_width" value="40"  type="INTEGER"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "logic_cell" value="5022"  type="INTEGER"  enable="1" />
// Retrieval info:      <PRIVATE name = "m512" value="0"  type="INTEGER"  enable="1" />
// Retrieval info:      <PRIVATE name = "m4k" value="9"  type="INTEGER"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "filename" value="fir32tap_old.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// =========================================================
// RELATED_FILES: fir32tap_old_st.v, fir32tap_old_constraints.tcl, fir32tap_old_st_wr.v, fir32tap_old_ast.vhd, fir32tap_old.v, fir32tap_old_ast.vhd, fir32tap_old.v;
// IPFS_FILES: fir32tap_old.vo;
// =========================================================
