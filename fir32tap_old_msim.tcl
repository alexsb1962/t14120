...
set megacore_wrapper_dir {D:/test/asvm/}
set megacore_lib_dir {c:/altera/11.0sp1/ip/altera/fir_compiler/lib/ip_toolbench/../}
set top_entity fir32tap_old
set timing_resolution "1ps"
set core_version "11.0"
set quartus_root_dir {c:/altera/11.0sp1/quartus/}
...
if {[string match $flow "simgen"]} {
    lappend vsim_cmd "-L" "Sgate" "-L" "altera_mf" "-L" "lpm" "-L" "auk_dspip_lib" "-L" "fir_work"
} 
