...
// 			sg_st
// ============================================================
// Generated by NCO 11.0 [Altera, IP Toolbench 1.3.0 Build 208]
// ************************************************************
...
// Retrieval info: <MEGACORE title="NCO"  version="11.0"  build="208"  iptb_version="1.3.0 Build 208"  format_version="120" >
// Retrieval info:  <NETLIST_SECTION active_core="sg_st" >
...
// Retrieval info:      <PRIVATE name = "FSAMP_VALUE" value="120"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "FREQ_VALUE" value="20"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "MPR" value="20"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "APR" value="20"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "APRI" value="20"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "PHI_INC" value="174763"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "MODULE_NAME" value="sg_st"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "NETLIST_FILE_NAME" value="sg_st.v"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "RCFC" value="sg_cos_c.mif"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCVC" value="sg_cos_c.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCHC" value="sg_cos_c.hex"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCFF" value="sg_cos_f.mif"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCVF" value="sg_cos_f.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCHF" value="sg_cos_f.hex"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSFC" value="sg_sin_c.mif"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSVC" value="sg_sin_c.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSHC" value="sg_sin_c.hex"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSFF" value="sg_sin_f.mif"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSVF" value="sg_sin_f.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSHF" value="sg_sin_f.hex"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "MAXC" value="20480"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "MAXF" value="20480"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RAWC" value="10"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RAWF" value="10"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RNWC" value="1024"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RNWF" value="1024"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RDW" value="20"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "NUM_LCELLS" value="2886"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "NUM_MEM_BITS" value="61440"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "NUM_EABS" value="7"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "NUM_DSP_BLOCKS" value="32"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "filename" value="sg.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "greybox">
// Retrieval info:      <PRIVATE name = "filename" value="sg_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// Retrieval info:     <PORT name = "phi_inc_i" direction="INPUT"  connect_to="phi_inc_i"  default="NODEFVAL"  high_width="19"  low_width="0"  description="" />
// Retrieval info:     <PORT name = "fsin_o" direction="OUTPUT"  connect_to="fsin_o"  default="NODEFVAL"  high_width="19"  low_width="0"  description="" />
// Retrieval info:     <PORT name = "fcos_o" direction="OUTPUT"  connect_to="fcos_o"  default="NODEFVAL"  high_width="19"  low_width="0"  description="" />
