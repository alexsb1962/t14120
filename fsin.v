...
// Retrieval info:  <NETLIST_SECTION active_core="fsin_st" >
...
// Retrieval info:      <PRIVATE name = "FSAMP_VALUE" value="150"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "FREQ_VALUE" value="8"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "PHI_INC" value="55924"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "MODULE_NAME" value="fsin_st"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "NETLIST_FILE_NAME" value="fsin_st.v"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "RCFC" value="fsin_cos_c.mif"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCVC" value="fsin_cos_c.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCHC" value="fsin_cos_c.hex"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCFF" value="fsin_cos_f.mif"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCVF" value="fsin_cos_f.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCHF" value="fsin_cos_f.hex"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSFC" value="fsin_sin_c.mif"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSVC" value="fsin_sin_c.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSHC" value="fsin_sin_c.hex"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSFF" value="fsin_sin_f.mif"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSVF" value="fsin_sin_f.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSHF" value="fsin_sin_f.hex"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "MAXC" value="16384"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "MAXF" value="16384"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "NUM_LCELLS" value="1064"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "NUM_MEM_BITS" value="49152"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "NUM_EABS" value="6"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "filename" value="fsin.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "greybox">
// Retrieval info:      <PRIVATE name = "filename" value="fsin_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
