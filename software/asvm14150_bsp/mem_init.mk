...
$(MEM_0)_START := 0x0a800000
$(MEM_0)_END := 0x0affffff
...
$(MEM_1)_START := 0x0b40b800
$(MEM_1)_END := 0x0b40bbff
$(MEM_1)_HIERARCHICAL_PATH := descf
$(MEM_1)_WIDTH := 32
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: descf
descf: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym

# Memory: descriptor_memory
MEM_2 := descriptor_memory
$(MEM_2)_NAME := descriptor_memory
...
$(MEM_2)_START := 0x0b408000
$(MEM_2)_END := 0x0b409fff
$(MEM_2)_HIERARCHICAL_PATH := descriptor_memory
$(MEM_2)_WIDTH := 32
$(MEM_2)_ENDIANNESS := --little-endian-mem
$(MEM_2)_CREATE_LANES := 0

.PHONY: descriptor_memory
descriptor_memory: check_elf_exists $(MEM_INIT_DIR)/$(MEM_2).hex $(HDL_SIM_DIR)/$(MEM_2).dat $(HDL_SIM_DIR)/$(MEM_2).sym

# Memory: onchip_memory2
MEM_3 := onchip_memory2
$(MEM_3)_NAME := onchip_memory2
...
$(MEM_3)_START := 0x0b404000
$(MEM_3)_END := 0x0b407fff
$(MEM_3)_HIERARCHICAL_PATH := onchip_memory2
$(MEM_3)_WIDTH := 32
$(MEM_3)_ENDIANNESS := --little-endian-mem
$(MEM_3)_CREATE_LANES := 0

.PHONY: onchip_memory2
onchip_memory2: check_elf_exists $(MEM_INIT_DIR)/$(MEM_3).hex $(HDL_SIM_DIR)/$(MEM_3).dat $(HDL_SIM_DIR)/$(MEM_3).sym
...
$(MEM_4)_START := 0x00000000
$(MEM_4)_END := 0x07ffffff
$(MEM_4)_HIERARCHICAL_PATH := sdram
$(MEM_4)_WIDTH := 32
$(MEM_4)_ENDIANNESS := --little-endian-mem
$(MEM_4)_CREATE_LANES := 0

.PHONY: sdram
sdram: check_elf_exists $(HDL_SIM_DIR)/$(MEM_4).dat $(HDL_SIM_DIR)/$(MEM_4).sym
